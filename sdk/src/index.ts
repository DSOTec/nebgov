...
export {
  ...
  subscribeToDelegationRegistered,
  subscribeToDelegationRevoked,
  subscribeToDelegationDepthLimitUpdated,
...
export type {
  ...
  DelegationRegisteredEventData,
  DelegationRevokedEventData,
  DelegationDepthLimitUpdatedEventData,
